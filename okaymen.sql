...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 15, 2019 at 06:05 AM
...
SELECT application.id,application.employee_id ,application.time_start, application.time_end, application.approver_id, application.notified_employee_id, application.reason, application.description, application.create_at, employee.name
FROM application, employee
WHERE application.approver_id = employee.id AND employee_id = emp_id;
END$$
